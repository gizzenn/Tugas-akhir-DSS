...
<body class="d-flex justify-content-center align-items-center py-5">
    <div class="card card-custom border-0 p-4 mx-3">
        <div class="text-center mb-4">
            ...
            <h4 class="fw-bold text-dark m-0">Login Staff</h4>
    ...
    <div class="mb-3">
        <label class="form-label small fw-semibold text-secondary">Alamat Email Staf</label>
        <input type="email" name="email" class="form-control py-2.5" style="border-radius: 10px;" placeholder="staff@rs.com" required>
    </div>
